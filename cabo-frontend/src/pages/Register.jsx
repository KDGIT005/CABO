...
export default function Register() {
  ...
  const handleEmailRegister = async (e) => {
    ...
    try {
      ...
      const token = await result.user.getIdToken();
      localStorage.setItem('cabo_token', token);
      const data = await api.syncUser({ name, phone: '' });
      login(data.user);
      addToast('Account created! Welcome to Cabo 🎉', 'success');
      navigate('/dashboard');
    } catch (err) {
  ...
  return (
    <div className="auth-page" style={{ animation: 'fadeIn 0.3s ease both' }}>
      {/* Left branding panel */}
      <div className="auth-left">
        ...
        <div className="auth-left-content">
          <div className="auth-left-tagline">
            Join the<br />Ride<br />Community.
          </div>
          <p className="auth-left-sub">
            Create your free account and start connecting with students heading your way.
          </p>
        </div>

        <div className="auth-left-badges">
          <span className="auth-badge">🚗 Free to Join</span>
          <span className="auth-badge">🛡️ Verified Students</span>
          <span className="auth-badge">💬 Built-in Chat</span>
        </div>
      </div>
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleEmailRegister} className="auth-form">
            <div className="form-group">
              <label htmlFor="register-name"><User size={13} /> Full Name</label>
            ...
            <div className="form-group">
              <label htmlFor="register-email"><Mail size={13} /> Email</label>
              <div className="input-icon-wrapper">
            ...
            <div className="form-group">
              <label htmlFor="register-password"><Lock size={13} /> Password</label>
              <div className="input-icon-wrapper">
            ...
            <div className="form-group">
              <label htmlFor="register-confirm"><Lock size={13} /> Confirm Password</label>
              <div className="input-icon-wrapper">
                <Lock size={17} className="input-icon" />
                <input
                  id="register-confirm"
